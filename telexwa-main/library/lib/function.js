...
// human-readable removed in slim build
const util = require('util')
// Jimp removed in slim build — generateProfilePicture is unused
...
exports.formatp = (bytes) => {
    ...
    const u=['B','KB','MB','GB','TB']; let i=0; let n=Math.abs(Number(bytes));
